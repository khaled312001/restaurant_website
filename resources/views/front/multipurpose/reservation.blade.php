...
@section('meta-keywords'){{$seoInfo->meta_keyword_reservation ?? ''}} @endsection
@section('meta-description'){{$seoInfo->meta_description_reservation ?? ''}} @endsection
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ convertUtf8($bs->reservation_title) }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="white-bg pt-130 pb-120">
                        <div class="reservation-tree">
                            <img class="lazy"
                                data-src="{{ asset('assets/front/img/' . $be->table_section_img) }}" alt="">
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-lg-10">
                                <div class="section-title text-center">
                                    <span>{{ convertUtf8($be->table_section_title) }} <img class="lazy"
                                            data-src="{{ asset('assets/front/img/title-icon.png') }}" alt=""></span>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="book-btn text-center mt-20">
                                                <button class="main-btn main-btn-2"
                                                    type="submit">{{ __('Book Table') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
