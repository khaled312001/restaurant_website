                        ...
                        <div class="col-lg-6 offset-lg-3">
                            ...
                            <form id="ajaxForm" class="" action="{{ route('admin.product.update') }}" method="post"
                                ...
                                <div id="app">
                                    ...
                                    <div class="row variant-box" v-for="(variant, index) in variants"
                                        :key="variant.uniqid">
                                        ...
                                        <div class="col-lg-1">
                                            <button class="btn btn-danger text-white btn-sm mt-5"
                                                @click="removeVariant(index)">
                                                <i class="fas fa-times"></i>
                                            </button>
                                        </div>
                                        <div class="col-lg-12">
                                            <button class="btn btn-success btn-sm" @click="addOption(index)">Add
                                                Option</button>
                                        </div>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <button class="btn btn-primary addbtn" @click="addAddOn">Add Add
                                                    On</button>
                                            </div>
                                        </div>
                                    </div>
